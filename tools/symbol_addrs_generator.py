...
def main():
    ...
    isAutogeneratedPadIndex = header.index("isAutogeneratedPad")
    ...
    for row in contextCsv[1:]:
        ...
        isAutogeneratedPad = row[isAutogeneratedPadIndex]
        ...
        if isAutogeneratedPad == "True":
            print(f" isAutogeneratedPad", end="")
        print()
