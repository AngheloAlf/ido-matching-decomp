...
#if defined(_SVR4_SOURCE) && !defined(_XOPEN_SOURCE)
...
#endif /* _SVR4_SOURCE && !_XOPEN_SOURCE */
...
/* IRIX4 error numbers with no SVR4 equivalents */
/* Note: New IRIX5 error numbers begin at 1000 */

#define	EDQUOT		1133	/* craft this to be __IRIXBASE + IRIX4 value */
#define	ENFSREMOTE	1135	/* -- ditto -- */

/*
 * The following are indexes into the IRIX4 errno table. Since they can't
 * change, they are provided for compatibility with IRIX4 code that may
 * have used these defines.
 *
 * DO NOT USE THESE FOR IRIX5 !!
 *
 */

#define ETCP_EBASE	100
#define	ETCP_ELIMIT	129
#define	ENAMI_EBASE	129
#define	ENAMI_ELIMIT	131
#define	ENFS_EBASE	131
#define	ENFS_ELIMIT	135
#define	ELASTERRNO	135

#if defined(_SGI_SOURCE) && !defined(_POSIX_SOURCE)

#define TCP_EBASE       ETCP_EBASE
#define TCP_ELIMIT      ETCP_ELIMIT
#define NAMI_EBASE      ENAMI_EBASE
#define NAMI_ELIMIT     ENAMI_ELIMIT
#define NFS_EBASE       ENFS_EBASE
#define NFS_ELIMIT      ENFS_ELIMIT
#define LASTERRNO       ELASTERRNO
